        ...
        {[
          ...
          <FormGroup controlId="formBasicText" key="input-old">
            <InputGroup>
              ...
              <FormControl type="text" placeholder="请输入旧登录密码"/>
            </InputGroup>
            <HelpBlock>　</HelpBlock>
          </FormGroup>,
          <FormGroup controlId="formBasicText" key="input-new">
            <InputGroup>
              ...
              <FormControl type="text"placeholder="请输入新登录密码"/> 
            </InputGroup>
            <HelpBlock>　</HelpBlock>
          </FormGroup>,
          <div className={style.container} key="input-btn">
            <SplitButton className={style.button} bsStyle="default" title="修改密码" id="btn" onSelect={this.props.changeForm}>
