...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(app, document.getElementById('react-root'));
...
/***/ function(module, exports) {
	...
	var TOGGLE_SETTING = 'Exotic/TOGGLE_SETTING';
	var PRESS_BTN = 'Exotic/TRY_PRESS_BTN';
	var PRESS_BTN_SUCC = 'Exotic/PRESS_BTN_SUCC';
	var PRESS_BTN_FAIL = 'Exotic/PRESS_BTN_FAIL';
	var RELEASE_BTN = 'Exotic/RELEASE_BTN';
	var RELEASE_BTN_SUCC = 'Exotic/RELEASE_BTN_SUCC';
	var RELEASE_BTN_FAIL = 'Exotic/RELEASE_BTN_FAIL';
	var OPEN_SWITCH = 'Exotic/OPEN_SWITCH';
	var OPEN_SWITCH_SUCC = 'Exotic/OPEN_SWITCH_SUCC';
	var OPEN_SWITCH_FAIL = 'Exotic/OPEN_SWITCH_FAIL';
	var CLOSE_SWITCH = 'Exotic/CLOSE_SWITCH';
	var CLOSE_SWITCH_SUCC = 'Exotic/CLOSE_SWITCH_SUCC';
	...
	var pressButton = exports.pressButton = function pressButton(id) {
	  return {
	    type: PRESS_BTN,
	    id: id
	  };
	...
	var pressButtonSucc = exports.pressButtonSucc = function pressButtonSucc(id) {
	  return {
	    type: PRESS_BTN_SUCC,
	    id: id
	  };
	...
	var pressButtonFail = exports.pressButtonFail = function pressButtonFail(id) {
	  return {
	    type: PRESS_BTN_FAIL,
	    id: id
	  };
	...
	var releaseButton = exports.releaseButton = function releaseButton(id) {
	  return {
	    type: RELEASE_BTN,
	    id: id
	  };
	...
	var releaseButtonSucc = exports.releaseButtonSucc = function releaseButtonSucc(id) {
	  return {
	...
	var releaseButtonFail = exports.releaseButtonFail = function releaseButtonFail(id) {
	  return {
	...
	var openSwitch = exports.openSwitch = function openSwitch(id) {
	  return {
	    type: OPEN_SWITCH,
	    id: id
	  };
	...
	var openSwitchSucc = exports.openSwitchSucc = function openSwitchSucc(id) {
	  return {
	...
	var openSwitchFail = exports.openSwitchFail = function openSwitchFail(id) {
	  return {
	...
	var closeSwitch = exports.closeSwitch = function closeSwitch(id) {
	  return {
	    type: CLOSE_SWITCH,
	    id: id
	  };
	...
	var closeSwitchSucc = exports.closeSwitchSucc = function closeSwitchSucc(id) {
	  return {
	...
	var closeSwitchFail = exports.closeSwitchFail = function closeSwitchFail(id) {
	  return {
	...
	var fpgaAcquired = exports.fpgaAcquired = function fpgaAcquired() {
	  return {
	    type: FPGA_ACQUIRED
	  };
	};
	
	var fpgaReleased = exports.fpgaReleased = function fpgaReleased() {
	  return {
	    type: FPGA_RELEASED
	  };
	};
	...
	exports.default = function () {
	  ...
	  var switches = Array.apply(undefined, _toConsumableArray(state.switches));
	  var buttons = Array.apply(undefined, _toConsumableArray(state.buttons));
	  switch (action.type) {
	    case OPEN_SWITCH:
	    case CLOSE_SWITCH:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = (_dec = (0, _reactRedux.connect)(function (state) {
	  ...
	  toggleSetting: _redux.toggleSetting
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'a',
	              { onClick: this.props.occupied ? _socket2.default.release : _socket2.default.acquire },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TYPE_ACTION = 0;
	var TYPE_STATUS = 1;
	var TPYE_OPERATION = 2;
	var TYPE_INFO = 3;
	var switchTimeout = Array(4).fill(undefined);
	var buttonTimeout = Array(4).fill(undefined);
	...
	socket.onmessage = function (event) {
	  ...
	  switch (data.type) {
	    case TYPE_STATUS:
	      switch (data.status) {
	        case 'switch_on':
	          _store2.default.dispatch((0, _redux.openSwitchSucc)(data.id));
	          clearTimeout(switchTimeout[data.id]);
	          break;
	        case 'switch_off':
	          _store2.default.dispatch((0, _redux.closeSwitchSucc)(data.id));
	          clearTimeout(switchTimeout[data.id]);
	          break;
	        case 'button_pressed':
	          _store2.default.dispatch((0, _redux.pressButtonSucc)(data.id));
	...
	var remote = {
	  openSwitch: function openSwitch(id) {
	    ...
	    _store2.default.dispatch((0, _redux.openSwitch)(id));
	    switchTimeout[id] = setTimeout(function () {
	      _store2.default.dispatch((0, _redux.openSwitchFail)(id));
	    }, 30000);
	  },
	  closeSwitch: function closeSwitch(id) {
	    send({
	      type: TPYE_OPERATION,
	      operation: 3,
	      id: id
	    });
	    _store2.default.dispatch((0, _redux.closeSwitch)(id));
	    switchTimeout[id] = setTimeout(function () {
	      _store2.default.dispatch((0, _redux.closeSwitchFail)(id));
	    }, 30000);
	  },
	  pressButton: function pressButton(id) {
	    send({
	      type: TPYE_OPERATION,
	      operation: 4,
	      id: id
	    });
	    _store2.default.dispatch((0, _redux.pressButton)(id));
	    buttonTimeout[id] = setTimeout(function () {
	      _store2.default.dispatch((0, _redux.pressButtonFail)(id));
	    }, 30000);
	  },
	  releaseButton: function releaseButton(id) {
	    send({
	      type: TPYE_OPERATION,
	      operation: 5,
	      id: id
	    });
	    _store2.default.dispatch((0, _redux.releaseButton)(id));
	    buttonTimeout[id] = setTimeout(function () {
	      _store2.default.dispatch((0, _redux.releaseButtonFail)(id));
	    }, 30000);
	  },
	  ...
	  _createClass(Panel, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { id: 'left' },
	        !this.props.setting ? _react2.default.createElement(
	          'div',
	          { id: 'left_contain' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Switches = (_dec = (0, _reactRedux.connect)(function (state) {
	  return {
	  ...
	  function Switches() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Switches).apply(this, arguments));
	  }
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          Array(4).fill(0).map(function (e, i) {
	            return _react2.default.createElement(
	              'li',
	              { key: i, className: 'switch_border',
	                style: { borderColor: occupied ? '#fff' : '#777' } },
	              _react2.default.createElement('div', { className: 'switch',
	                onClick: !_this2.props.occupied ? null : status[i] === 0 /* SW_OFF */ ? _socket2.default.openSwitch.bind(undefined, i) : status[i] === 1 /* SW_ON  */ ? _socket2.default.closeSwitch.bind(undefined, i) : undefined,
	                style: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Upload = (_dec = (0, _reactRedux.connect)(function (state) {
	  ...
	  function Upload() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Upload)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      file: null
	  ...
	  _createClass(Upload, [{
	    key: 'render',
	    value: function render() {
	      var color = this.props.occupied ? '#fff' : '#777';
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'li',
	              { id: 'file_input', style: { backgroundColor: color, borderColor: color } },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var KeyStroke = function (_React$Component) {
	  _inherits(KeyStroke, _React$Component);
	
	  function KeyStroke() {
	    _classCallCheck(this, KeyStroke);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(KeyStroke).apply(this, arguments));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var handleClick = function handleClick() {
	  var content = $("#input_biu").val();
	  _socket2.default.broadcast(content);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'li',
	            { id: 'biu', className: 'click_button', onClick: handleClick },
	            'BIU'
	          )
	        )
	      );
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'button_border' },
	            _react2.default.createElement('div', { className: 'button button_choosen' })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'setting_word' },
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'li',
	              { id: 'upload', className: 'click_button' },
	              'CONFIRM'
	            ),
	            _react2.default.createElement(
	              'li',
